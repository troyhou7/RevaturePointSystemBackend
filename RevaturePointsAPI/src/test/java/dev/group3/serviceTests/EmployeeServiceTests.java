...
public class EmployeeServiceTests {
    ...
    @BeforeEach
    void beforeAll() {
        Employee e1 = new Employee(1,"Associate", "Parker", "Hoskovec", "PHoskovec", "password", 0, 0, 1,"x");
        Employee e2 = new Employee(1,"Trainer", "Xianbin", "Zhen", "XZhen", "password", 0, 0, 1,"x");
        Employee e3 = new Employee(1,"Associate", "Troy", "Houston", "THouston", "password", 0, 0, 2,"x");
        ...
        prizes.add(new Prize(1, "Reva Points", 500, "reva points for reva points?","x"));
        prizes.add(new Prize(1, "A new car!", 500, "made by micro machines","x"));
